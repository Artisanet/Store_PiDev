...
public class SigninController implements Initializable {
    ...
    void Signin(ActionEvent event) {
        ...
        if (PFpassword_signup.getText().trim().isEmpty() || PFpassword_signup.getText().length() < 6) {
            errors.append("- Please enter a Password at least 6 caracters.\n");
        }
        ...
        if (!isNumeric(TFnumber.getText()) || TFnumber.getText().trim().length() != 8) {
